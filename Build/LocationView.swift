...
struct LocationView: View {
    ...
    @State private var location = MKCoordinateRegion(center:CLLocationCoordinate2DMake(40.7484, -73.9857), span:MKCoordinateSpan(latitudeDelta: 0.005, longitudeDelta: 0.005))
    var body: some View {
        ZStack{
            ...
            CarLocationPanel()
            LinearGradient(gradient: Gradient(colors:[Color("DarkGrey"),Color.clear, Color.clear]), startPoint: .top, endPoint: .bottom)
